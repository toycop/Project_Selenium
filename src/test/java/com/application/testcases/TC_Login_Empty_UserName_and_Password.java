...
public class TC_Login_Empty_UserName_and_Password extends BaseClass
{
	WebDriver driver;
	...
	public void loginApp()
	{
		...
		Reporter.log("TC_Login_Empty_UserName_and_Password: Test case execution started here", true);
		...
		Reporter.log("TC_Login_Empty_UserName_and_Password: Test case execution Ends here", true);
