...
public class TC_Login_WildCharecters_In_Username_Password extends BaseClass
{
	WebDriver driver;
	...
	public void loginApp()
	{
		...
		Reporter.log("TC_Login_WildCharecters_In_Username_Password: Test case execution started here", true);
		...
		Reporter.log("TC_Login_WildCharecters_In_Username_Password: Test case execution Ends here", true);
